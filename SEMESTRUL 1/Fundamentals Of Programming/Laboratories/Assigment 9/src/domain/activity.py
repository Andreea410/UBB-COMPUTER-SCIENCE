...
class Activity:
    ...
    def __str__(self):
        return (" activity id: " + str(self._activity_id) +
                " persons ids: "+str(self.person_ids)+"  date: "+self._date +
                "  start time: "+ self._start_time+ "  end time: "+ self._end_time+ "  description: "+self._description)