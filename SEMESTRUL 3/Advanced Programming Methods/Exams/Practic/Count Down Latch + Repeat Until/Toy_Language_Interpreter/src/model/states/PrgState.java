...
public class PrgState {
    ...
    //CONSTRUCTOR
    public PrgState(IMyStack<IStmt> e , IMyDictionary<String,IValue> dictionary , IMyList<String> list , IStmt InitialStatement , IMyDictionary<StringValue , BufferedReader> fileTable , IMyHeap heap, IMyLatchTable table,int ParentFlag)
    {
        this.exeStack = e;
