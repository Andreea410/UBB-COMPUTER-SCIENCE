...
public class Interpreter
{
    public static void main(String[] args){
        ...
        IStmt statement11 = new CompStmt(new VariablesDeclarationStmt("v1", new RefType(new IntIType())),
                new CompStmt(new VariablesDeclarationStmt("v2", new RefType(new IntIType())),
                        new CompStmt(new VariablesDeclarationStmt("v3", new RefType(new IntIType())),
                                new CompStmt(new VariablesDeclarationStmt("cnt", new IntIType()),
                                        new CompStmt(new HeapAllocationStatement( new ValueExpression(new IntIValue(2)),"v1"),
                                                new CompStmt(new HeapAllocationStatement (new ValueExpression(new IntIValue(3)),"v2"),
                                                        new CompStmt(new HeapAllocationStatement( new ValueExpression(new IntIValue(4)),"v3"),
                                                                new CompStmt(new NewBarrierStatement("cnt",new HeapReadExpression(new VariableExpression("v2"))),
                                                                        new CompStmt(new ForkStatement(
                                                                                new CompStmt(new AwaitStatement("cnt"),
                                                                                        new CompStmt(new HeapWriteStatement( new ArithmeticalExpression( new HeapReadExpression(new VariableExpression("v1")), ArithmeticalOperator.MULTIPLY,new ValueExpression(new IntIValue(10))),"v1"), new PrintStm(new HeapReadExpression(new VariableExpression("v1")))
                                                                                                )
                                                                                        )
                                                                                ),
                                                                                new CompStmt(
                                                                                        new ForkStatement(
                                                                                                new CompStmt(
                                                                                                        ...
                                                                                                        new CompStmt(
                                                                                                                new HeapWriteStatement( new ArithmeticalExpression( new HeapReadExpression(new VariableExpression("v2")), ArithmeticalOperator.MULTIPLY,new ValueExpression(new IntIValue(10))),"v2"),
                                                                                                                new CompStmt(
                                                                                                                        new HeapWriteStatement( new ArithmeticalExpression( new HeapReadExpression(new VariableExpression("v2")), ArithmeticalOperator.MULTIPLY,new ValueExpression(new IntIValue(10))),"v2"),
                                                                                                                        new PrintStm(new HeapReadExpression(new VariableExpression("v2")))
                                                                                                                )
                                                                                                        )
                                                                                                )
                                                                                        ),
                                                                                        new CompStmt(
                                                                                                new AwaitStatement("cnt"),
                                                                                                new PrintStm(new HeapReadExpression(new VariableExpression("v3")))
                                                                                        )
                                                                                )
                                                                        )
                                                                )
        ...
        //int v=1; fork(v=2) ; fork(v=3)
        IStmt testStatement = new CompStmt(new VariablesDeclarationStmt("v", new IntIType()),
                new CompStmt(new AssignStmt("v", new ValueExpression(new IntIValue(1))),
                        new CompStmt(new ForkStatement(new AssignStmt("v", new ValueExpression(new IntIValue(2)))),
                                new ForkStatement(new AssignStmt("v", new ValueExpression(new IntIValue(3)))))));

        IRepository repoTest = new Repository("logTest.txt");
        Controller controllerTest = new Controller(repoTest);
        controllerTest.addProgram(testStatement);
        ...
        menu.addCommand(new RunExampleCommand("test", testStatement.toString(), controllerTest));
