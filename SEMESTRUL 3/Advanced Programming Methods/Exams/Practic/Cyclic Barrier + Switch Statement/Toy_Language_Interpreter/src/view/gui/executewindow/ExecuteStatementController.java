...
public class ExecuteStatementController {
    ...
    @FXML
    private TableView<Map.Entry<Integer,MyPair<Integer , List<Integer>>>> barrierTableView;
    @FXML
    ...
    @FXML
    private TableColumn<Map.Entry<Integer, javafx.util.Pair<Integer, List<Integer>>>, String> listValuesBarrierTableColumn;
    ...
    {
        PrgState currentProgramState = getCurrentProgramState();
        var barrierTable = Objects.requireNonNull(currentProgramState).getBarrierTable();
        ArrayList<Map.Entry<Integer,MyPair<Integer,List<Integer>>> > barrierTableContent = new ArrayList<>();
        for(Map.Entry<Integer,MyPair<Integer,List<Integer>>> entry: barrierTable.getContent().entrySet())
            barrierTableContent.add(entry);
        barrierTableView.getItems().clear();
        for(Map.Entry<Integer,MyPair<Integer,List<Integer>>> entry: barrierTableContent)
        {
            barrierTableView.getItems().add(entry);
        }
    }
