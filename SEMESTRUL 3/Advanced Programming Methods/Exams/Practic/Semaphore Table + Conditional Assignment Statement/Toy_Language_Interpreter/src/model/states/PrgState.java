...
public class PrgState {
    ...
    private IMySemaphoreTable semaphoreTable;
    ...
    //CONSTRUCTOR
    public PrgState(IMyStack<IStmt> e , IMyDictionary<String,IValue> dictionary , IMyList<String> list , IStmt InitialStatement , IMyDictionary<StringValue , BufferedReader> fileTable , IMyHeap heap,IMySemaphoreTable semaphoreTable)
    {
        this.exeStack = e;
    ...
    public String toString() {
        return "ID = " + this.id +
                ...
                "\nHeap = " + HeapToString() +
                "\nSemaphore Table = " +
                (semaphoreTable != null ? semaphoreTable.toString() : "null") +
                "\n====================>" +
                "\n";
    }
    ...
    public IMySemaphoreTable getSemaphoreTable()
    {
        return this.semaphoreTable;
    }

    public void setSemaphoreTable(IMySemaphoreTable semaphoreTable)
    {
        this.semaphoreTable = semaphoreTable;
    }
