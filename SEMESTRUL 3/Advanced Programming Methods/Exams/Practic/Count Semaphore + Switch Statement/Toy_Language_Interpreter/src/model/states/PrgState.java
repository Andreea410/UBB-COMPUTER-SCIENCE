...
public class PrgState {
    ...
    private IMySemaphore semaphoreTable;
    ...
    //CONSTRUCTOR
    public PrgState(IMyStack<IStmt> e , IMyDictionary<String,IValue> dictionary , IMyList<String> list , IStmt InitialStatement , IMyDictionary<StringValue , BufferedReader> fileTable , IMyHeap heap,IMySemaphore semaphoreTable)
    {
        this.exeStack = e;
    ...
    public IMySemaphore getSemaphoreTable() {
        return semaphoreTable;
    }

    public void setSemaphoreTable(IMySemaphore semaphoreTable) {
        this.semaphoreTable = semaphoreTable;
    }
}
